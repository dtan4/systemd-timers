...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder Dir.pwd, "/home/ubuntu/src/github.com/dtan4/systemd-timers"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd /home/ubuntu/src/github.com/dtan4/systemd-timers' >> /home/ubuntu/.bashrc
  SHELL
end
